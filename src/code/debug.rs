...
pub fn lookup(byte: u8) -> Option<(&'static [usize], &'static str)> {
    match byte {
        ...
        SetLVar::VAL => Some((SetLVar::OPERAND_COUNTS, "SetLVar")),
        GetLVar::VAL => Some((GetLVar::OPERAND_COUNTS, "GetLVar")),
        ToTuple::VAL => Some((ToTuple::OPERAND_COUNTS, "ToTuple")),
        ToSet::VAL => Some((ToSet::OPERAND_COUNTS, "ToSet")),
        ToTupleRn::VAL => Some((ToTupleRn::OPERAND_COUNTS, "ToTupleRn")),
        ToSetRn::VAL => Some((ToSetRn::OPERAND_COUNTS, "ToSetRn")),
        ToFn::VAL => Some((ToFn::OPERAND_COUNTS, "ToFn")),
